...
execute_command "Deploying oneinfra 20.05.0-alpha17..." "kubectl apply -f https://raw.githubusercontent.com/oneinfra/oneinfra/20.05.0-alpha17/config/generated/all.yaml"
