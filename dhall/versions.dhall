...
let releaseData/ToJSON =
      Prelude.JSON.object
        ( toMap
            { consoleVersion = Prelude.JSON.string consoleVersion
            , defaultKubernetesVersion =
                Prelude.JSON.string defaultKubernetesVersion.kubernetesVersion
            , kubernetesVersions = kubernetesVersions/ToJSON kubernetesVersions
            }
        )
...
let testData/ToJSON =
      Prelude.JSON.object
        ( toMap
            { containerdVersions = containerdVersions/ToJSON containerdVersions
            , kubernetesVersions =
                kubernetesTestVersions/ToJSON kubernetesVersions
            }
        )
