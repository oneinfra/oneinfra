...
in  ''
    ...
    1. Create a [managed cluster](../config/samples/simple-cluster.yaml):
        ...
        ```console
        $ kubectl apply -f https://raw.githubusercontent.com/oneinfra/oneinfra/${oneinfraVersion}/config/samples/simple-cluster.yaml
    ...
    3. (optional) You can then create a [second managed
       ...
       three control plane instances:
        ...
        ```console
        $ kubectl apply -f https://raw.githubusercontent.com/oneinfra/oneinfra/${oneinfraVersion}/config/samples/ha-cluster.yaml
