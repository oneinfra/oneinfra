...
if ! which oi-local-hypervisor-set &> /dev/null; then
    ONEINFRA_PATH=/tmp/oneinfra-20.06.0-alpha18
    mkdir -p ${ONEINFRA_PATH}
    wget -O ${ONEINFRA_PATH}/oi-local-hypervisor-set https://github.com/oneinfra/oneinfra/releases/download/20.06.0-alpha18/oi-local-hypervisor-set-linux-amd64-20.06.0-alpha18
...
execute_command "Deploying oneinfra 20.06.0-alpha18..." "kubectl apply -f https://raw.githubusercontent.com/oneinfra/oneinfra/20.06.0-alpha18/config/generated/all.yaml"
