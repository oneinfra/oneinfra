...
import (
	v1alpha1 "github.com/oneinfra/oneinfra/pkg/clientsets/manager/typed/cluster/v1alpha1"
...
func (c *FakeClusterV1alpha1) Components(namespace string) v1alpha1.ComponentInterface {
