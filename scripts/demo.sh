...
execute_command "Deploying oneinfra 20.05.0-alpha16..." "kubectl apply -f https://raw.githubusercontent.com/oneinfra/oneinfra/20.05.0-alpha16/config/generated/all.yaml"
