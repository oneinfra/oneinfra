...
|--------------------|----------------------|----------------------|
| `1.15.12`          | `{ONEINFRA_VERSION}` |                      |
| `1.16.13`          | `{ONEINFRA_VERSION}` |                      |
| `1.17.9`           | `{ONEINFRA_VERSION}` |                      |
| `1.18.6`           | `{ONEINFRA_VERSION}` |                      |
| `1.19.0`           | `{ONEINFRA_VERSION}` | `{ONEINFRA_VERSION}` |
| `1.20.0-alpha.0`   | `{ONEINFRA_VERSION}` |                      |
| `1.21.0`           | Next release         |                      |
